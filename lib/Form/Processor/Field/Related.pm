package Form::Processor::Field::Related;
use strict;
use warnings;
...
# prob'ly don't want subform... not prepared to handle
# properly in Model::DBIC. What DO we want to do here?
    $self->sub_form(
        Form::Processor->new(
...
# Here we take a "value" that may have come from the database
# and put it into the form in the fields that we see in an
# HTML form
    my $name = $self->name;
